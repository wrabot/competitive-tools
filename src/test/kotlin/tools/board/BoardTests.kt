...
class BoardTests {
    ...
    fun testData() {
        ...
        assertEquals(true, b.isValid(0, 1))
        assertEquals(false, b.isValid(4, 1))
        assertEquals(true, b.isValid(XY(3, 1)))
        assertEquals(false, b.isValid(XY(0, 3)))
        assertEquals('5', b.getOrNull(0, 1))
        assertEquals(4, b.indexOf(0, 1))
        assertEquals(9, b.indexOf(1, 2))
